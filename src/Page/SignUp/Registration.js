    ...
    <div className={style.logo}>
     ...
     <span>.in</span>
      ...
      <div className={style.card}>
        ...
        <div className={style.form}>
            <label className={style.mobile}>Mobile No</label>
        ...
        <div className={style.form}>
            ...
            <input type="text" placeholder='At least 6 character'></input>
